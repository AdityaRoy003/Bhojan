// Bhojan — Premium Responsive Email Templates with Embedded CSS Animations & Hover Transitions
const BRAND_COLOR = '#ff4d4d';
const BRAND_DARK = '#1a1a1a';
const BRAND_GOLD = '#d4af37';
const BRAND_SECONDARY = '#4f46e5';

// Shared premium layout header & styling
const emailStyles = `
<style>
...
const emailTemplates = {
        ...
        <body>
            <div class="email-container">
                <div class="header-security">
                    <h1 style="color: #ffffff; margin: 0; font-size: 32px; font-weight: 800;">🔐 Bhojan Security</h1>
                    <p style="color: #fbcfe8; font-size: 14px; margin-top: 5px; font-weight: 600; text-transform: uppercase;">Password Recovery</p>
                </div>
                <div class="content-body" style="text-align: center;">
                    <h2 style="color: #1e293b; font-weight: 800; font-size: 22px;">Verification Code</h2>
                    <p>Use the secure verification code below to reset your Bhojan password. This code is active for 10 minutes.</p>
                    
                    <div style="background: #f1f5f9; padding: 20px; border-radius: 16px; display: inline-block; font-size: 32px; font-weight: 800; letter-spacing: 6px; color: #0f172a; border: 1px solid #e2e8f0; margin: 25px 0;">
                        ${otp}
                    </div>

                    <p style="font-size: 13px; color: #64748b;">If you did not request this, please secure your account immediately or ignore this email.</p>
                </div>
                <div class="footer">
        ...
        <body>
            <div class="email-container">
                <div class="header-gradient" style="background: linear-gradient(135deg, #f97316 0%, #e11d48 100%);">
                    <h1 class="floating-accent" style="color: #ffffff; margin: 0; font-size: 36px; font-weight: 800; text-shadow: 0 3px 6px rgba(0,0,0,0.15);">✨ ${campaign.festivalName || 'Festival Special'} ✨</h1>
    ...
    loginAlert: (details) => `
        ...
        <body>
            <div class="email-container">
                <div class="header-security">
                    <h1 style="color: #ffffff; margin: 0; font-size: 30px; font-weight: 800;">🛡️ Security Alert</h1>
        ...
        <body>
            <div class="email-container">
                <div class="header-security" style="border-bottom-color: #ef4444;">
                    <h1 style="color: #ffffff; margin: 0; font-size: 30px; font-weight: 800;">⚠️ Critical Warning</h1>
                ...
                <div class="content-body">
                    <h2 style="color: #ef4444; font-weight: 800; font-size: 20px; margin-top: 0;">Multiple Failed Logins detected</h2>
                    ...
                    <div style="background: #fff5f5; border: 1px solid #feb2b2; padding: 20px; border-radius: 16px; margin: 20px 0; color: #9b2c2c; font-size: 14px;">
                        ...
                        <ul style="margin: 10px 0 0 20px; padding: 0;">
                            <li>Account lock status: ${details.isLocked ? '🔐 Locked for 15 minutes' : '⚠️ Warning status'}</li>
                            <li>Last attempt source IP: ${details.ip || 'Unknown'}</li>
        ...
        <body>
            <div class="email-container">
                ...
                <div class="content-body" style="text-align: center;">
                    ...
                    <div style="background: #f8fafc; border: 1px solid #e2e8f0; padding: 20px; border-radius: 16px; display: inline-block; font-size: 32px; font-weight: 800; letter-spacing: 6px; color: #1e293b; margin: 25px 0;">
                        ${details.code}
                    </div>

                    <p style="font-size: 13px; color: #64748b;">If you are locked out or don't have access to this email, you can use one of your backup recovery codes to log in.</p>
                </div>
                <div class="footer">
                    <p>&copy; 2026 Bhojan Security. All rights reserved.</p>
                </div>
    ...
    accountRecovery: (details) => `
        ...
        <body>
            <div class="email-container">
                ...
                <div class="content-body">
                    <h2 style="color: #1e293b; font-weight: 800; font-size: 20px; margin-top: 0;">Step-by-Step Recovery Guidance</h2>
                    ...
                    <ol style="padding-left: 20px; font-size: 15px; color: #475569; line-height: 1.8;">
                        ...
                        <li style="margin-bottom: 10px;">Input the OTP and choose a new password. Make sure it contains uppercase, lowercase, numbers, and symbols.</li>
                        <li style="margin-bottom: 10px;">Once updated, log in and verify your recovery settings in <strong>Profile Settings -> Security</strong>.</li>
                    </ol>
        ...
        <body>
            <div class="email-container">
                ...
                <div class="content-body">
                    ...
                    <p>Bhojan is fully GDPR compliant. Your information is securely handled and encrypted at all times. If you did not trigger this request, please contact our Data Protection Officer immediately.</p>
                </div>
                <div class="footer">
